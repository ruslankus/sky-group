...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, min-width=380">
...
<body>
    <section class="header-slider">
        ...
        <div class="slider-block">
            <div class="slider-wrapper cycle-slideshow" data-cycle-swipe="true" data-cycle-pager=".slider-nav" data-cycle-slides=".slide" data-cycle-pause-on-hover="true" data-cycle-speed="1000">
