...
<section class="content">
    <div class="content-col left">
        ...
        <img src="<?php echo Yii::app()->request->baseUrl ?>/img/about1.jpg">
         <p><strong>Sky Group</strong> IS A PRIVATE MEMBERS-ONLY CLUB WHICH UNITES different communities of people INTO A SINGLE NETWORK FOR THE PURPOSE OF RECEIVING PRIVILEGED SERVICES. SKY GROUP OFFERS 5 DIFFERENT TYPES OF MEMBERSHIP PLANS AT AN AFFORDABLE PRICE FROM WHICH YOU CAN CHOOSE A PLAN THAT SATISFIES ALL THE needs of YOU AND YOUR FAMILY.</p>
        <p>WE CONSTANTLY EXPAND OUR LIST OF SERVICES AND OFFERS that is why OUR CLIENTS ALWAYS RECEIVE A WIDE RANGE OF SERVICES THAT ARE OF THE HIGHEST QUALITY.</p>
