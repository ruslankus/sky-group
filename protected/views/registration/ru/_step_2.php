...
<section class="form-area">
   <?php echo CHtml::beginForm();?>
        <fieldset class="reg-1">
           <span class="promo underline">Номер ID</span>
            ...
            <input placeholder="Имя (указывается во время заполнения первой страницы)" type="text" value="<?php echo $step_1['first_name']; ?>" readonly="readonly" />
            <input placeholder="Фамилия (указывается во время заполнения первой страницы)" type="text" value="<?php echo $step_1['last_name']; ?>" readonly="readonly" />
...
?>
        ...
        <fieldset class="reg-2">
            <label class="like-input">Адрес места жительства</label>
            ...
            <select class="<?php echo $errors['country']? 'error' : '' ?>" data-error="<?php echo $errors['country']; ?>" placeholder="Страна" type="text" name="country" value="<?php echo $sessData['country']; ?>" style="width: 95%;float:right;">
